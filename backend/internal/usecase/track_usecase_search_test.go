...
func (m *mockCacheRepo) InvalidateStreamURL(ctx context.Context, artist, title string) error {
	return nil
}
func (m *mockCacheRepo) InvalidateDevice(ctx context.Context, deviceID string) error {
	return nil
}
