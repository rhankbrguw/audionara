abstract final class GeneralStrings {
  ...
  static const String serverUnavailable = 'Server is temporarily unavailable. Please try again later.';
  static const String invalidServerResponse = 'Invalid server response format.';
