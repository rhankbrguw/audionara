...
extension PlaylistItemQueryWhere
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistItemQuerySortBy
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> sortByAlbumId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'albumId', Sort.asc);
    });
  }

  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> sortByAlbumIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> sortByArtistId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'artistId', Sort.asc);
    });
  }

  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> sortByArtistIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistItemQuerySortThenBy
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> thenByAlbumId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'albumId', Sort.asc);
    });
  }

  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> thenByAlbumIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'albumId', Sort.desc);
    });
  }
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> thenByArtistId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'artistId', Sort.asc);
    });
  }

  QueryBuilder<PlaylistItem, PlaylistItem, QAfterSortBy> thenByArtistIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'artistId', Sort.desc);
    });
  }
...
extension PlaylistItemQueryWhereDistinct
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QDistinct> distinctByAlbumId({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistItem, PlaylistItem, QDistinct> distinctByArtistId({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistItemQueryProperty
  ...
  QueryBuilder<PlaylistItem, String, QQueryOperations> albumIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistItem, String, QQueryOperations> artistIdProperty() {
    return QueryBuilder.apply(this, (query) {
