    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          ...
          style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textInverse, letterSpacing: 0.2),
        ),
        const SizedBox(height: 4),
        Text(
          '${AuthStrings.resetPasswordDesc}\n${widget.email}',
          textAlign: TextAlign.center,
          style: const TextStyle(fontSize: 12.5, color: AppColors.textInverse70, height: 1.3),
        ),
            ...
            return Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text(
                  ...
                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textInverse),
                ),
